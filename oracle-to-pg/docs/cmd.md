...
# Convert Oracle PACKAGE (use ora2pg-package.conf)
ora2pg -c ora2pg-package.conf -i ora-sql/ng_rep_other-processed.sql -o pg-sql/ng_rep_other.sql

# Other packages:
# ora2pg -c ora2pg-package.conf -i ora-sql/<package>-processed.sql -o pg-sql/<package>.sql