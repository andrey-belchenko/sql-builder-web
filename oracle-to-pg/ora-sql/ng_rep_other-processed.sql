 ...
 END;  -- end FUNCTION get_email_all(p_kodp NUMBER)
   ...
   , itog as (
          ...
          ,   (CASE WHEN n.edizm =23
              ...
              , a.pr_hand
          FROM  pre
             INNER JOIN report_dev.nv_account a ON pre.kod_account = a.kod_account
             LEFT JOIN ( select  nal.kod_account as kod_account
                           ...
                           from  ec_account.nr_account s
                               inner join report_dev.nv_account_sost_nal nal ON s.kod_account = nal.kod_account
                               cross join pars
