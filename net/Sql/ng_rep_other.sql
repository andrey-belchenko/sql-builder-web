 ...
 END;  -- end FUNCTION get_email_all(p_kodp NUMBER)
   ...
   , itog as (
          ...
          FROM  pre
             ...
             LEFT JOIN sr_facras fr ON frt.kod_ras = fr.kod_ras         -- добавлено 12.12.2024
             LEFT join sr_facvip fv ON fr.kod_sf = fv.kod_sf and a.kod_dog = fv.kod_dog and a.ym = fv.ym                -- добавлено 10.07.2025 (по рекомендации Александра Д.)
 ...
 BEGIN
    ...
    SELECT
     ...
     FROM kr_dogovor ds
         ...
         INNER JOIN sr_facvip fv ON ds.kod_dog = fv.kod_dog
