...
select a.KOD_ACCOUNT_SOST, a.KOD_ACCOUNT_PRIEM, a.TIP_TARIF_SOST, a.CUST,a.PRICE,a.KOD_ACCOUNT, n.kod_nal, n.kod_naltax, n.pr_add,n.tax,
  ...
  from (select b.kod_account, n.pr_add, n.kod_nal, n.tax, n.kod_naltax, nvl(sum(n.nal),0) nal,
   case when b.nachisl-nvl(sum(nal),0)=0 then 0 else nvl(sum(n.nal),0)/(nachisl-nvl(sum(nal),0)) end drob from  nr_account b, nr_account_nal n where n.kod_account(+)=b.kod_account
   group by b.kod_account, n.pr_add, n.kod_nal, n.tax, n.kod_naltax, b.nachisl) n, nr_account_sost a where n.kod_account=a.kod_account
