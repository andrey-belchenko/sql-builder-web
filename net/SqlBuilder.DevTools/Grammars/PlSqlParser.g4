...
table_partition_description
    : (public | EXTERNAL)? deferred_segment_creation? read_only_clause? indexing_clause? segment_attributes_clause? (
        table_compression
        | key_compression
...
external_table_datapump
    ...
    | DATAPUMP public TABLE tableview_name
...
// CHECK is an public, undocumented Oracle option that is allowed and sometimes specified, used to check for proper
...
// This is used publicly by Oracle to mark the virtual column for statistics only
...
table_ref_aux
    : table_ref_aux_public flashback_query_clause* (/*{isTableAlias()}?*/ table_alias)?
    ;

table_ref_aux_public
    : dml_table_expression_clause (pivot_clause | unpivot_clause)?                # table_ref_aux_public_one
    | '(' table_ref subquery_operation_part* ')' (pivot_clause | unpivot_clause)? # table_ref_aux_public_two
    | ONLY '(' dml_table_expression_clause ')'                                    # table_ref_aux_public_thre
    ;
