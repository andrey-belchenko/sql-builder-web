...
public interface IPlSqlParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterSql_plus_command_no_semicolon([NotNull] PlSqlParser.Sql_plus_command_no_semicolonContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="PlSqlParser.sql_plus_command_no_semicolon"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitSql_plus_command_no_semicolon([NotNull] PlSqlParser.Sql_plus_command_no_semicolonContext context);
	/// <summary>
