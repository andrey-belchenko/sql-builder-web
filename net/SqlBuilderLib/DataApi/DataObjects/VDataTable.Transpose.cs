...
namespace sql.builder.DataApi
{
    ...
    class VDataTableTransposeUtils
    {
        ...
        private static object readRowOrReaderVal(DataRow row, Oracle.ManagedDataAccess.Client.OracleDataReader tr, string columnName)
        {
            if (row != null)
            {
        ...
        private static string addDimValFromRow(GrsetData grset, DataRow row, string keyColumnName, List<string> otherCols,Oracle.ManagedDataAccess.Client.OracleDataReader tr)
        {
