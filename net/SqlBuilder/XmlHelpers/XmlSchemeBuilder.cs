...
namespace sql.builder.XmlHelpers
{
    public class XmlSchemeBuilder
    {
        ...
        {
            VOracleParameter[] parameters = new VOracleParameter[1] { new VOracleParameter("constraint_name", VOracleDbType.VarChar, constraint_name, ParameterDirection.Input) };
