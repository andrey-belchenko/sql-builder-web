...
namespace sql.builder.DataApi
{
    ...
    /// </summary>
    internal static class APredicate
    {
        #region Условные предикаты (типа Func&lt;XAttribute, bool&gt;)
        internal static bool IsBehaviorColumns(XAttribute a)
        {
        ...
        internal static bool IsCallAttributes(XAttribute a)
        {
            Contract.Assert(a != null);
            XName name = a.Name;
        ...
        internal static bool IsAdditionalAttribute(XAttribute a)
        {
            Contract.Assert(a != null);
        ...
        internal static bool IsCustomLayoutOptions(XAttribute a)
        {
            Contract.Assert(a != null);
        ...
        internal static bool IsLayoutOptions(XAttribute a)
        {
            Contract.Assert(a != null);
        ...
        internal static bool IsColumnRecoveredAttribute(XAttribute a)
        {
            Contract.Assert(a != null);
        ...
        internal static bool IsColumnAttributeCanDub(XAttribute a)
        {
            Contract.Assert(a != null);
            XName name = a.Name;
        ...
        internal static bool IsSectRoleAttribute(XAttribute a)
        {
            Contract.Assert(a != null);
            XName name = a.Name;
        ...
        internal static string AttributeValue(XAttribute a)
        {
            Contract.Assert(a != null);
            return a.Value;
        }
