    ...
    public class ExcelPrintMultiplicatedSheet : ExcelPrintSheet
    {
        ...
        public override ExcelPrintSheet Print(DataSet data, bool use_data_reader)
        {
            ...
            else
            {
                ...
                if (list.Count > 1 && !use_data_reader)
                { // т.к. дочерние строки читаются в оригинальном порядке , родительские тоже нужно оставить в оригинальном, можно организовать сортировку листов Excel , после печати
